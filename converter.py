...
class VideoToPLYConverter:
    ...
    def _convert_using_pycolmap(self, video_path, ply_path, fps, skip_ba):
        ...
        work_dir = os.path.join(os.path.dirname(ply_path), "data")       # data
        if not os.path.exists(work_dir):
            os.mkdir(work_dir)
        
        image_dir = os.path.join(work_dir, "images")                     # data/images
        ...
        distorted_path = os.path.join(work_dir, "distorted")             # data/distorted
        database_path = os.path.join(distorted_path, "database.db")      # data/distorted/database.db
        sparse_path = os.path.join(distorted_path, "sparse")             # data/distorted/sparse
    ...
    def _run_training(self, ply_path):
        ...
        # parser2.add_argument("--save_iterations", nargs="+", type=int, default=[3_000])
